...
c.ShowAlert(a);return k};this.CreateConfirmAlertWithCancel=function(){};this.CreateWebPageAlert=function(){};this.CreateCustomAlert=function(a,f,e,l){var d="SMAClientAlert"+g.GetAlertIndex();f=b.CreateBaseAlert(d,f,null);f.firstChild.classList.add("Info");f.firstChild.childNodes[1].firstChild.innerHTML="";f.firstChild.childNodes[1].firstChild.appendChild(a);c.ShowAlert(f);var h={resolve:null,reject:null};(new Promise(function(a,b){h.resolve=a;h.reject=b})).then(function(a){c.RemoveAlert(d);e&&"function"==
typeof e&&e(a)},function(a){c.RemoveAlert(d);l&&"function"==typeof l&&l(a)});f.firstChild.firstChild.firstChild.firstChild.childNodes[2].onclick=function(){h.resolve()};return h};this.RemoveAllAlerts=function(){return c.RemoveAllAlerts()};return this}])})();
